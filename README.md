...
## OpenShift 4 Development Environment: 

- Setup CodeReady Containers (CRC) on Laptop
- Setting up CodeReady Containers (CRC) on a Remote Server and Remote Access to CRC from Laptop.
